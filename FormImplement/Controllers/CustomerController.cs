    ...
    public class CustomerController : Controller
    {
        ...
        public IActionResult Form(int CustomerID)
        {
            ...
            foreach (DataRow dataRow in table.Rows)
            {
                ...
                customerModel.NetAmount = Convert.ToInt32(@dataRow["NetAmount"]);
        ...
        public IActionResult CustomerSave(CustomerModel customerModel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                command.Parameters.Add("@GSTNO", SqlDbType.VarChar).Value = customerModel.GST_NO;
        ...
        public IActionResult CustomerList(CustomerModel customerModel)
        {
